...
schema = {
    "$id": "http://twopif.net/rtrain/schema/training-job/1.0",
    ...
    "type": "object",
    "required": ["architecture", "weights", "loss", "optimizer", "epochs",
                 "x_train", "y_train", "x_train_shape", "y_train_shape"],
    "additionalProperties": False,
    "properties": {
        "architecture": {"type": "string"},
        "weights": {
            "type": "array",
            "items": { "$ref": "#/definitions/ndarray" }
        },
        "loss": {"type": "string"},
        "optimizer": {"type": "string"},
        "x_train": {"$ref": "#/definitions/ndarray"},
        "y_train": {"$ref": "#/definitions/ndarray"},
